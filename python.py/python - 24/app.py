...
#
from math import sqrt # sqrt - kvadrat ildiz xisoblaydigon funksiya
...
harf='o'
mevalar_b = list(filter(lambda meva:meva.startswith(harf),mevalar)) # filter - saralaw .startswith(harf) - matn bn iwleydigan metod
print(mevalar_b)
